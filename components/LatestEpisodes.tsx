      ...
      <div className="columns-3 md:columns-4 xl:columns-6 ">
        {latestEpisodeData.map((data) => (
          ...
          >
            ...
            <Image
              alt={data.name}
              className="transform rounded-lg brightness-90 transition will-change-auto group-hover:blur-sm group-hover:brightness-100"
            ...
            <div className="flex flex-col space-y-2 items-start text-white whitespace-nowrap">
              <h3 className="text-sm font-bold">
                {data.name.slice(0, 20)}
                {data.name.length > 20 ? "..." : ""}
              </h3>
              <p className="text-sm text-gray-300">{data.type}
