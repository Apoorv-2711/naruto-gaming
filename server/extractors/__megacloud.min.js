    ...
    function to(l, _, C, N, X, ee) {
      return (
        ...
        eU(function (ee, et, en, er) {
          ...
          } else (ed = ti(ed === et ? ed.splice(eu, ed.length) : ed)), X ? X(null, et, ed, er) : eS.apply(et, ed);
        })
      );
    }
    function ta(l, _) {
      ...
      _default: {
        ...
        set: function (l) {
          e6.fx.step[l.prop]
            ? e6.fx.step[l.prop](l)
            : 1 === l.elem.nodeType &&
              (null != l.elem.style[e6.cssProps[l.prop]] || e6.cssHooks[l.prop])
            ...
            eo
              ? (ea.ifModified &&
                ...
                204 === _ || "HEAD" === ea.type
                  ...
                  : 304 === _
                  ? (ep = "notmodified")
                  : ((ep = ef.state), (ed = ef.data), (eo = !(e_ = ef.error))))
                  ...
                  N(_, C) &&
                    ...
                    (ee[C] =
                      "" === er || null == er
                        ...
                        : /color/i.test(en)
                        ? "#" +
                          (0, X.vk)(er.toString(16).replace(/^0x/i, ""), 6)
                        : Math.ceil(er) + "px"));
          ...
          if (_.mobile === l) {
            ...
            ea.isMobileFallback(C)
              ? (ee = X.isPhoneSized(N)) === l
                ...
                : ee
                ? ((_.mobile = _.phone = ea.FALLBACK_PHONE), (_.tablet = null))
